...
Split panes let you run Claude on one side and browse your project files on the other. When Claude writes a plan to a file, you can read it while Claude is still working. Each command and its output is a discrete block — no scrolling through walls of output to find what Claude ran. You can also run multiple instances of Claude Code simultaneously, each in its own pane.
...
Full documentation for `CLAUDE.md` and skills is in the [official docs](https://code.claude.com/docs/en/features-overview).
