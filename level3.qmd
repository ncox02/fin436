...
As a session runs, everything accumulates in the context window: your instructions, the files the agent read, the code it wrote, the test output, your feedback. This window has a fixed size, passed back and forth with every message. Once it fills, the agent starts dropping the oldest entries to make room.
...
Copy this structure into any project before your first session. Fill in `CLAUDE.md` with your project's standing instructions and you are ready to start.
...
All new functions need a test in tests/.
```

Full documentation for `CLAUDE.md` and skills is at [code.claude.com](https://code.claude.com/docs/en/overview).
