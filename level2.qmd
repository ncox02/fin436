...
If you are using **Copilot agent mode** (select "Agent" from the dropdown at the top of the chat panel), Copilot will create the folders and files directly. Switch to agent mode before sending this prompt.

If you are in standard chat mode, Copilot will give you terminal commands. Run them in the VS Code integrated terminal (`` Ctrl+` ``).
