...
Level 2 has two keys: `Tab` accepts what AI proposes. `Ctrl+I` opens inline chat. `Ctrl+Alt+I` opens the Copilot Chat sidebar. Everything else is reading and deciding.
